<template>
  <div id="app" @keyup.esc="closeFundo()">
    <menuDesktop/>
    <img class="mob" src="@/assets/img/upLips_img/fretefree.jpg" style="max-width: 100%;">
    <menuMob/>
    <alert />
...
export default {
  components: {
    menuDesktop: () => import("@/components/gerais/menuDesktop.vue"),
   ...
   rodape: () => import("@/components/gerais/rodape.vue"),    
    hichat: () => import("@/components/gerais/hichat.vue"),
