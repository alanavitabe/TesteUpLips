...
export default {
  components: {
    ...
    bannerUpLips: () => import('@/components/gerais/bannerUpLips.vue'),
    seloCredibilidade: () => import("@/components/gerais/seloCredibilidade.vue"),
    AcidoUpLIps: () => import("@/components/gerais/AcidoUpLIps.vue"),
    famososUpLips: () => import("@/components/gerais/famososUpLips.vue"),
    bannerTresCores: () => import("@/components/gerais/bannerTresCores.vue"),
    bannerInfo: () => import("@/components/gerais/bannerInfo.vue"),
    kitProdutos: () => import("@/components/gerais/kitProdutos.vue"),   
    Bocao5min: () => import("@/components/gerais/Bocao5min.vue"),
    duvidasHome: () => import("@/components/gerais/duvidasHome.vue"),
    compraSegura: () => import("@/components/gerais/compraSegura.vue"),   
    roletapop: () => import(`@/components/gerais/roletaDaSorte.vue`),  
  },
  data(){
    return {
      banners: [],
