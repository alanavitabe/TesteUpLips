                ...
                <div class="row" style="max-width:100%;">
                    ...
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:50px;margin-bottom:20px;line-height:50px;">Up Lips Nude <br/> <span style="font-size:30px;margin-left:3px;">Compre 1 Leve 2</span></h1>
...
.btnSingleProduct{
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url("../../assets/img/upLips_img/uplips1-2.png");
                background-size:50%;
                height: 470px;
