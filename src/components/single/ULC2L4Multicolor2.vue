                ...
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob">
                            <img src='@/assets/img/upLips_img/uplips2-6.png' alt="" style="width:500px; height:500px; margin-left:-75px">
                        </div>
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:50px;margin-bottom:20px;line-height:50px;">Up Lips Multicolor 2 <br/> <span style="font-size:30px;margin-left:3px;">Compre 2 Leve 4</span></h1>
                            ...
                            <div class="precos_alt">
                                <p style="color:#6b6b6b;font-size:20px;display:inline;margin:0px 20px"><s>De: 239,70</s></p>
                                <p style="font-weight:bold;color:#000;font-size:25px;display:inline;margin:0px 20px;"><strong>Por: R$ 149,70</strong></p>
                                <img class="my-3" src="@/assets/img/img-ou.png" alt="" style="display:block;margin:0 auto;">
                                <p style="color:#000;font-size:20px;text-align:center;">12x de R$ 12,48 sem juros</p>
                            </div>
...
.btnSingleProduct{
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url("../../assets/img/upLips_img/uplips2-6.png");
                background-size:50%;
                height: 470px;
