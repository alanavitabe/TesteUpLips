      ...
      <div class="bg-modal" id="trocaBgModal">
        ...
        <div class="inforoleta">
          <div class="roleta_fechar">
            ...
            <img src="@/assets/img/roleta/fecharAfter.png" id="roleta_fecharAfter" alt="">
          </div>
...
function clear_interval(t) {
  ...
  $("#spin").click(function () {
    ...
    setTimeout(function () {
      ...
      $.ajax({
        url: "https://www.uplips.com.br/checkout/ajax/ajax-cupom-desconto.php",
        type: "post",
        data: {
...
img#roleta_fechar, img#roleta_fecharAfter {
    width: auto;
    position: relative;
    top: -150px;
...
#wheel .sec:nth-child(1) p,
#wheel .sec:nth-child(1) span,

#wheel .sec:nth-child(3) p,
#wheel .sec:nth-child(3) span,

#wheel .sec:nth-child(5) p,
#wheel .sec:nth-child(5) span{
    color:#656565
}
...
#spin {
  ...
  -ms-user-select: none;
  user-select: none;
  background-image: url(../../assets/img/roleta/girar.gif);
...
.bg-modal {
  ...
  background-image: url(../../assets/img/roleta/bg-modal_uplips_novo.png);
  width: 1200px;
  height: 700px;
  margin: 0 auto;
  background-repeat: no-repeat;
...
@media screen and (max-width: 768px) {
  .bg-modal {
    background-image: url(../../assets/img/roleta/bg-modal-mobile-uplips.png);
    transition: background-image 0.2s ease-in-out;
  }
  .estruturaRoleta {
