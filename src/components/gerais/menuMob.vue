<template>
    <header class="mobf justify-content-around">
        <li class="">
            <i class="fas fa-bars"></i>
        </li>

        <a href="/">
            <img class="logoMob" src="@/assets/img/upLips_img/logo-nova.png" alt="">
        </a>

        <a href="https://www.uplips.com.br//checkout/carrinho/">
            <img class="svgCart" width="28.5" height="27" src="@/assets/renova/cartsvg.svg" alt="">
            <div class="headerContainerTop-carrinho-num"> 0 </div>
        </a>
            ...
            <ul class="itensMenu">
                ...
                <li><a href="/pagina/perguntas-frequentes">Perguntas Frequentes</a></li>
                ...
                <li><a href="/checkout/acesso">Meus Pedidos</a></li>
                <li><a href="/checkout/acesso">Minha conta</a></li>
            </ul>
    </header>
</template>
